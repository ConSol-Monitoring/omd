...
my $network_exceptions = '/^(\s*|.*01mailrc.txt.gz.*saved.*|.*Network is unreachable.*|.*Temporary failure in name resolution.*|.*Name or service not known.*|200 OK|ERROR 503:.*)$/s';
