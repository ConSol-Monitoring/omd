...
DATATYPE::SERVICEPERFDATA	TIMET::%d	HOSTNAME::xxx	SERVICEDESC::range	SERVICEPERFDATA::asd label1=1;2; other=1;3;4asdasdasd	SERVICECHECKCOMMAND::perfdataLengthCheckDiscarded	SERVICESTATE::0	SERVICESTATETYPE::1
DATATYPE::SERVICEPERFDATA	TIMET::%d	HOSTNAME::xxx	SERVICEDESC::range	SERVICEPERFDATA::asd label2=1;2; other=1;3;4asdasdasd  [anza=ffgg] [si signo=11] 'valid[1]'=5 [si_errno=0] [si_code=1]	SERVICECHECKCOMMAND::perfdataLengthCheckDiscarded	SERVICESTATE::0	SERVICESTATETYPE::1
DATATYPE::SERVICEPERFDATA	TIMET::%d	HOSTNAME::xxx	SERVICEDESC::range	SERVICEPERFDATA::asd label3=1;2; other=1;3;4asdasdasd  [anza=ffgg] [si signo=11] 'valid[1]'=5 [si_errno=0] [si_code=1]fasdgew	SERVICECHECKCOMMAND::perfdataLengthCheckDiscarded	SERVICESTATE::0	SERVICESTATETYPE::1
