...
my $expected_plugin_outputs = get_expected_plugin_outputs(); # test data is shared with the naemon test
$expected_plugin_outputs->{'localhost'}->{'test_kill.pl'} = { like => ['/UNKNOWN: Return code of 11 is out of bounds./', '/Plugin exited by signal: segmentation fault./'], state => 3 };
