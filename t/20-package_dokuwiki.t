...
my $tests = [
  ...
  { cmd => "/bin/su - $site -c 'lib/monitoring-plugins/check_http -H localhost -t 60 -u /$site/wiki -e 401'",                          like => '/HTTP OK:/' },
  { cmd => "/bin/su - $site -c 'lib/monitoring-plugins/check_http -H localhost -t 60 -a omdadmin:omd -u /$site/wiki -e 301'",          like => '/HTTP OK:/' },
  { cmd => "/bin/su - $site -c 'lib/monitoring-plugins/check_http -H localhost -t 60 -a omdadmin:omd -u /$site/wiki/ -e 302'",         like => '/HTTP OK:/' },
  { cmd => "/bin/su - $site -c 'lib/monitoring-plugins/check_http -H localhost -t 60 -a omdadmin:omd -u /$site/wiki/doku.php -e 200'", like => '/HTTP OK:/' },
  { cmd => "/bin/su - $site -c 'lib/monitoring-plugins/check_http -H localhost -t 60 -a omdadmin:omd -u \"/$site/wiki/doku.php?id=start&do=export_pdf\" -e 200'", like => '/HTTP OK:/' },
