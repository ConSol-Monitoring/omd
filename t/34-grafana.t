...
TestUtils::test_command({ cmd => "/bin/su - $site -c 'lib/nagios/plugins/check_http -t 60 -H localhost -a omdadmin:omd -u /".$site."/grafana/ -s \"<title>Grafana</title>\"'", like => '/HTTP OK:/' });
