...
command [ process_perfdata_timeout ] = check_logfiles --logfile=$OMD_ROOT$/var/pnp4nagios/log/perfdata.log --tag=timeout --criticalpattern TIMEOUT --nologfilenocry --seekfilesdir=$OMD_ROOT$/tmp --protocolsdir=$OMD_ROOT$/tmp


#--- check for errors in npcd.log
command [ error_in_npcd_log        ] = check_logfiles --logfile=$OMD_ROOT$/var/pnp4nagios/log/npcd.log --tag=error --criticalpattern ERROR --nologfilenocry --nologfilenocry --seekfilesdir=$OMD_ROOT$/tmp --protocolsdir=$OMD_ROOT$/tmp
