...
command [ process_perfdata_timeout ] = check_logfiles --logfile=$OMD_ROOT$/var/pnp4nagios/log/perfdata.log --tag=timeout --criticalpattern TIMEOUT --nologfilenocry

#--- check for errors in npcd.log
command [ error_in_npcd_log        ] = check_logfiles --logfile=$OMD_ROOT$/var/pnp4nagios/log/npcd.log --tag=error --criticalpattern ERROR --nologfilenocry
