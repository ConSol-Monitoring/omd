...
TestUtils::test_command({ cmd => "/bin/su - $site -c 'lib/nagios/plugins/check_nwc_health --snmpwalk /tmp/test.snmpwalk --mode my-nwc-test --with-mymodules-dyn-dir=/tmp'", exit => 1, like => '/WARNING - delta_counter is 11/' });
TestUtils::test_command({ cmd => "/bin/su - $site -c 'lib/nagios/plugins/check_nwc_health --snmpwalk /tmp/test.snmpwalk --mode my-nwc-test --with-mymodules-dyn-dir=/tmp'", exit => 2, like => '/CRITICAL - delta_counter is 0/' });
