...
<head>
 ...
 <title>[% SERVICEDESC %] is [% SERVICESTATE %]</title>
 <style type="text/css">
<!--
table {
...
.serviceOK       { background-color: #00FF33; }
.serviceUNKNOWN  { background-color: #FF9E00; }
.serviceWARNING  { background-color: #FFDE00; }
.serviceCRITICAL { background-color: #FF5B33; }
  ...
  <tr>
   ...
   <td style="vertical-align: top; width: 501px;">
    <div style="text-align: center; font-size: 24px;">
     ...
     [% IF BASEURL != "" %]<a href="[% BASEURL %]thruk/cgi-bin/extinfo.cgi?type=2&host=[% HOSTNAME %]&service=[% SERVICEDESC %]">[% END %]
...
my $end   = time();
my $start = $end-86400;
print `~/bin/thruk --local -a graph --host='[% HOSTNAME %]' --service='[% SERVICEDESC %]' --width=900 --height=200 --start=$start --end=$end --format=base64`;
[% END %]
[% CATCH %]
  <tr>
